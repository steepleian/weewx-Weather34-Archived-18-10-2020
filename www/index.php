...
<?php if ($position6=='forecast3ds.php' || ($dshourly=='yes' && $apikey!= '11111111111111' && ($position6=='forecast3wu.php' || $position6=='forecast3wularge.php'))) {echo '<a alt="Alerts" title="Alerts" href="meteoalarmalerts.php" data-lity>&nbsp;'. $chartinfo. " Alerts</a>";}?></span>
