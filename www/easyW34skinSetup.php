...
$al_ip = "'. $_POST["al_ip"]. '";
$al_country = "'. $_POST["al_country"]. '";
$al_region = "'. $_POST["al_region"]. '";
$al_url = "'. $_POST["al_url"]. '";
$al_interval = "'. $_POST["al_interval"]. '";
$al_filename = "'. $_POST["al_filename"]. '";
$aq_url = "'. $_POST["aq_url"]. '";
...
$cc_interval = "'. $_POST["cc_interval"]. '";
$cc1_url = "'. $_POST["cc1_url"]. '";
$cc1_filename = "'. $_POST["cc1_filename"]. '";
$cc2_url = "'. $_POST["cc2_url"]. '";
$cc2_filename = "'. $_POST["cc2_filename"]. '";
...
<span style="color:rgba(236, 87, 27, 1.000);">
 ...
 <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
  ...
  <select id="services" name="services" class="choose1">
            ...
            <option>ds.me.eq.ki.al</option>
            <option>ds.me.eq.ki.wu.al</option>
...
<br/>
  ...
  <label name="al_interval"></label>
        <div class="stationvalue">Meteoalarm</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <select id="al_interval" name="al_interval" class="choose1">
         <option><?php echo $al_interval ;?></option>
  ...
  <label name="al_ip"></label>
        <div class="stationvalue">IP address for this device</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <input name="al_ip" type="text" id="al_ip" value="<?php echo $al_ip ;?>" class="choose">
     <br/> <span style="color:#777;">If not running on port 80 please include port number <span style="color:rgba(236, 87, 27, 1.000);">e.g 192.168.1.52:88 if running on port 88</span>
  
  <label name="al_country"></label>
        <div class="stationvalue">Meteoalarm Country Code (Two Character Upper Case)</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <input name="al_country" type="text" id="al_country" value="<?php echo $al_country ;?>" class="choose">
     <br/> 
  
  <label name="al_region"></label>
        <div class="stationvalue">Meteoalarm Region Code (Numeric)</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <input name="al_region" type="text" id="al_region" value="<?php echo $al_region ;?>" class="choose">
     <br/> <span style="color:#777;">Country and Location code found here <span style="color:rgba(236, 87, 27, 1.000);">https://www.meteoalarm.eu/</span>
...
<center><a href="http://weewx.com" title="http://weewx.com" target="_blank"><img src="img/icon-weewx.svg" width="120" /></a></center><br/>
  ...
  <input id="al_url" type="hidden" name="al_url" value="http://$al_ip/weewx/weather34/eualert.php?country=$al_country&region=$al_region"/><br/>
  </div>
  <input id="al_filename" type="hidden" name="al_filename" value="$jsondatapath/meteoalarm.txt"/><br/>
  </div>
  ...
  <input id="cc_interval" type="hidden" name="cc_interval" value="300"/><br/>
  </div>
  <input id="cc1_url" type="hidden" name="cc1_url" value="https://api.sat24.com/crop?type=visual5hdcomplete&lat=$lat&lon=$lon&width=300&height=300&zoom=1.00&continent=$continent"/><br/>
  <input id="cc1_filename" type="hidden" name="cc1_filename" value="$jsondatapath/sat1.png"/><br/>
  </div>
  <input id="cc1_filename" type="hidden" name="cc1_filename" value="$jsondatapath/sat1.png"/><br/>
  </div>
  <input id="cc2_url" type="hidden" name="cc2_url" value="https://api.sat24.com/crop?type=infraPolair&lat=$lat&lon=$lon&width=300&height=300&zoom=1.00&continent=$continent"/><br/>
  </div>
  <input id="cc2_filename" type="hidden" name="cc2_filename" value="$jsondatapath/sat2.png"/><br/>
  </div>
