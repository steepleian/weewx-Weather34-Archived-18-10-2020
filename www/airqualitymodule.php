...
?>
<div class="updatedtime"><span><?php if(file_exists('airqualitydata.php') && time() - filemtime('airqualitydata.php')<1800) {
  echo $online." ".date($timeFormat, filemtime('airqualitydata.php'));
  } else {
