...
<html>
<head>
    <title>WeeWX Weather34 Pre-install settings1.php Settings Page</title>
    <style>
        * {
...
<body>
    ...
    <p>Weather34 for WeeWX. Pre-install settings page, generating settings1.php. The file will be automatically sent to your defaults Downloads folder. No data is retained on this server after the process is complete.</p>
...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-25">
        ...
        <div>
            <input type="submit" id="bt1" value="Create and Download settings1.php" onclick="saveFile()" />
        </div>
            </div>
...
<script>
    let saveFile = () => {
        ...
        const sFileName1 = 'settings1.php';	   // The file to save the data.

        let newLink = document.createElement("a");
        newLink.download = sFileName1;

        if (window.webkitURL != null) {
            newLink.href = window.webkitURL.createObjectURL(textToBLOB1);
        }
        else {
            newLink.href = window.URL.createObjectURL(textToBLOB1);
